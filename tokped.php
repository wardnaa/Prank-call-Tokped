...
Class Bom {
     ...
     public $type;
         ...
         curl_setopt ($ch, CURLOPT_USERAGENT, "Mozzila/5.0 (Windows;U; Windows NT 6.1; en-US; rv:1.8.1.6) Gecko/20070725 Firefox/2.0.0.6");
         ...
         $headres[] = 'X-Requested-With: XMLHtppRequest';
   ...
   private function getStr($start, $end, $staring) {
       if (!empty($string)) {
    ...
    public function Verif()
    {
        ...
        // echo $send;
        if (preg_match('/apt_attempt_left/', $send)) {
                print('Sukses cuk!');
